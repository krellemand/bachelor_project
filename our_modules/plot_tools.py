...
def plot_roc(ax, roc_stats, **plt_kwargs):
    """
    Plots the roc cruve on a given ax given the scoring values roc_stats"""
    fprs, tprs, _ = roc_stats
    ax.plot(fprs, tprs, **plt_kwargs)


# Plots of images from the dataset or images with pertubations
...
# Used for testing with median. But we ended up only using median.
